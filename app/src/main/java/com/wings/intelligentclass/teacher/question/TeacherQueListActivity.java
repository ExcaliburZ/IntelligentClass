package com.wings.intelligentclass.teacher.question;
...
public class TeacherQueListActivity extends AppCompatActivity {
        ...
        questionListCall.enqueue(new Callback<List<Question>>() {
            ...
            public void onResponse(Call<List<Question>> call, Response<List<Question>> response) {
                if (response.body() == null || response.code() / 100 != 2) {
                    ToastUtils.showToast(TeacherQueListActivity.this, "获取问题失败");
                    return;
                }
                mQuestionList = response.body();
                QuestionListAdapter adapter = new QuestionListAdapter();
                mQueListRecyclerView.setLayoutManager(new LinearLayoutManager(TeacherQueListActivity.this));
    ...
    private class QuestionListAdapter extends RecyclerView.Adapter<ClassHolder> {
        ...
        public ClassHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View itemView = LayoutInflater
                    .from(TeacherQueListActivity.this).inflate(R.layout.item_question_list_view, parent, false);
        ...
        public void onBindViewHolder(ClassHolder holder, int position) {
            ...
            holder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent intent = new Intent(TeacherQueListActivity.this, StudentAnswerListActivity.class);
